package com.hackathon.chat.views.main;

import com.hackathon.chat.views.chat.ChatView;
import com.hackathon.chat.views.join.JoinView;
...
@PWA(name = "Finbo", shortName = "Finbo")
...
public class MainView extends AppLayout implements AfterNavigationObserver {
    ...
    public MainView(List<Bot> bots) {
        ...
        createMenuTabs();
        Div poweredBy = new Div(new Span(new Text("Powered by: Hawk Eyes")));
        Div footer = new Div(poweredBy);
        footer.addClassName("footer");
        VerticalLayout menu = new VerticalLayout(new H3("Helpers:"), tabs, footer);
